...
class New5 extends StatefulWidget {
  @override
  State<New5> createState() => _New5State();
}

class _New5State extends State<New5> {
  Future<void> EcoDialogue(String a) async {
    showDialog(
      context: context,
        ...
        children: [
          Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(285, 0, 0, 0),
                child: InkWell(
                  onTap: (() {
